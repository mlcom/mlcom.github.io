## ALBERT (a lite bert) : How To Train a Language Model From Scratch Using Custom Data (Complete Tutorial)
In this blog post, we will learn how to create a customized Albert (a lite Bert) language model from scratch using hugging face transformers on custom data set.
